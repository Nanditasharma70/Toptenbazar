...
@section('content')
    ...
    <div class="flex flex-col md:flex-row justify-between items-center  mb-6">
        <h1 class="text-2xl font-semibold">Delivery Man</h1>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                table = new $('.data-table').DataTable({
                    ...
                    "language": {
                        "searchPlaceholder": "Search Delivery Man",
                        "processing": '<i class="fa fa-spinner" aria-hidden="true"></i>',
                    },
                    ajax: {
                        url: "{{ route('delivery-man.index') }}",
                    },
                    "columns": [{
                            "data": "id",
            ...
            $(document).on('click', '#deleteModal .confirm-delete-btn', function() {
                ...
                const deleteUrlTemplate = "{{ route('delivery-man.delete', ['slug' => '___slug___']) }}";
                $.ajax({
