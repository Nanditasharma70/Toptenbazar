...
@section('title', 'Banner Config')
@section('content')
    <div class="flex flex-col md:flex-row justify-between items-center  mb-6">
        <h1 class="text-2xl font-semibold"> Banner Config</h1>
        <div class="flex space-x-4 mt-4 md:mt-0">
            <a href="{{ route('banner.create') }}" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">+
                Banner Config</a>
        </div>
    </div>
            ...
            <table class="min-w-full bg-white border border-gray-200 text-sm text-left text-gray-800 data-table">
                <thead class="bg-gray-100 text-gray-600 uppercase text-xs font-semibold">
                    <tr>
                        ...
                        <th class="px-4 py-3 whitespace-nowrap">Banner Name</th>
        ...
        <script>
            ...
            $(document).ready(function() {
                table = new $('.data-table').DataTable({
                    ...
                    "language": {
                        "searchPlaceholder": "Search Banner Config",
    ...
    $(document).on('click', '#deleteModal .confirm-delete-btn', function () {
        ...
        const deleteUrlTemplate = "{{ route('banner.delete', ['slug' => '___slug___']) }}";
        $.ajax({
