...
@section('title', ' Add Banner Config')
@section('content')
    <div class="flex flex-col md:flex-row justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Add Banner Config</h1>
        <a href=""
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            ...
            <!-- Product Name -->
            <form id="banner_config_form" method="POST" enctype="multipart/form-data">
                @csrf
            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 mb-2">
                    Banner Name <span class="text-red-500">*</span>
                </label>
                <input type="text" placeholder="Enter Banner Name" id="name" name="name"
                    ...
                    <div>
                        ...
                        <article aria-label="File Upload Modal"
                            ...
                            <header class="text-center">
                                ...
                                <input id="hidden-input" type="file" name="images" id="images" 
                                    class="hidden" />
  ...
  @push('scripts')
    <script>
         document.addEventListener("DOMContentLoaded", () => {
            ...
            // form submit
            $('#banner_config_form').on('submit', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        toastr.success(response.message || "Banner saved successfully!");
                        $('#banner_config_form')[0].reset();
