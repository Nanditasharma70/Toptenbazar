...
@section('content')
    ...
    <div class="">
        ...
        <div class="flex flex-col xs:flex-row justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Add Units</h1>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <div class="mb-6">
                 ...
                 {{-- <div class="mb-6">
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        Unit Slug <span class="text-red-500">*</span>
                    </label>
                    <input type="text" placeholder="Kg-hdhd"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition" />
                </div>
                 --}}
        ...
        $('#unit_form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    toastr.success(response.message || "Unit saved successfully!");
                    $('#unit_form')[0].reset();
                },
                error: function(xhr) {
                           $('#loader').hide();
