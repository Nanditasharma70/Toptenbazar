...
@section('content')
    ...
    <div class="flex flex-col md:flex-row justify-between items-center  mb-6">
        <h1 class="text-2xl font-semibold">Sub Category</h1>
    ...
    <div class="bg-white rounded-xl shadow-md p-4 w-full overflow-x-auto">
        ...
        <table class="min-w-full text-sm text-left  data-table">
            <thead class="bg-tablehead text-xs uppercase text-darkblack border-b border-none ">
                <tr>
  ...
  var table;
    ...
    $(document).on('click', '#deleteModal .confirm-delete-btn', function () {
        ...
        const deleteUrlTemplate = "{{ route('sub-categories.delete', ['slug' => '___slug___']) }}";
        $.ajax({
