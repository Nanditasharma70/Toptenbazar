...
@section('content')
    ...
    <div class="">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Add Sub Category</h1>
            <div>
                ...
                <div class="bg-white rounded-xl shadow-md p-6">
                    ...
                    <!-- Sub Category Name -->
                     ...
                     {{-- <div class="mb-6">
                        ...
                        <select name="category_id" id="category_id" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
            ...
            $('#sub_cat_form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        toastr.success(response.message || "SubCategory saved successfully!");
